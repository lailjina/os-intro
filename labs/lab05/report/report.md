...
![Просмотр каталога /tmp командой ls -F (fig:005)](image/img5.png){#fig:005}

![Просмотр каталога /tmp командой ls -alF (fig:006)](image/img6.png){#fig:006}
...
![Удаление папок letters, memos, misk (fig:0012)](image/img12.png){#fig:012}
...
![Отсутствие опций команды cd (fig:018)](image/img18.png){#fig:018}
...
![Опции команды rmdir (fig:021)](image/img21.png){#fig:021}
...
![Опции команды rm (fig:022)](image/img22.png){#fig:022}
